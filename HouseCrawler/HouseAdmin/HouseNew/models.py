...
class AreaSaleInfo(Document):
    ...
    AreaName = fields.StringField(default='', max_length=1024, null=False)
    AreaSaleNumDay = fields.StringField(default='', max_length=1024, null=False)
    AreaSaleNumSum = fields.StringField(default='', max_length=1024, null=False)
    AreaSaleAreaDay = fields.StringField(default='', max_length=1024, null=False)
    AreaSaleAreaSum = fields.StringField(default='', max_length=1024, null=False)
    AreaSalePriceDay = fields.StringField(default='', max_length=1024, null=False)
    AreaSalePriceSum = fields.StringField(default='', max_length=1024, null=False)
