...
class ProjectInfoHandleMiddleware(object):
    ...
    def process_spider_output(self, response, result, spider):
        ...
        if response.meta.get('PageType') == 'ProjectInfo':
            ...
            pinfo['ProjectBaseLicenseCode'] = sel.xpath('//body/div/div/div[1]/table/tr[2]/td[4]/text()').extract_first() or ''
            pinfo['ProjectCompany'] = sel.xpath('//body/div/div/div[1]/table/tr[3]/td[2]/text()').extract_first() or ''
            pinfo['ProjectBuildingNum'] = sel.xpath('//body/div/div/div[1]/table/tr[3]/td[4]/text()').extract_first() or ''
            pinfo['ProjectAddress'] = sel.xpath('//body/div/div/div[1]/table/tr[4]/td[2]/text()').extract_first() or ''
            pinfo['ProjectBasePrice'] = sel.xpath('//body/div/div/div[1]/table/tr[4]/td[4]/text()').extract_first() or ''
            pinfo['ProjectSaleAddress'] = sel.xpath('//body/div/div/div[1]/table/tr[5]/td[2]/text()').extract_first() or ''
            pinfo['ProjectSalePhone'] = sel.xpath('//body/div/div/div[1]/table/tr[5]/td[4]/text()').extract_first() or ''
            ...
            pinfo['ProjectTotalArea'] = sel.xpath('//body/div/div/div[1]/table/tr[7]/td[2]/text()').extract_first() or ''
            pinfo['ProjectBuildingArea'] = sel.xpath('//body/div/div/div[1]/table/tr[8]/td[2]/text()').extract_first() or ''
            pinfo['ProjectDesignCompany'] = sel.xpath('//body/div/div/div[1]/table/tr[7]/td[4]/text()').extract_first() or ''
            pinfo['ProjectSaleAgent'] = sel.xpath('//body/div/div/div[1]/table/tr[8]/td[4]/text()').extract_first() or ''
            pinfo['ProjectManageCompany'] = sel.xpath('//body/div/div/div[1]/table/tr[9]/td[4]/text()').extract_first() or ''
            pinfo['ProjectBuildCompany'] = sel.xpath('//body/div/div/div[1]/table/tr[10]/td[4]/text()').extract_first() or ''
            pinfo['ProjectFinishAt'] = sel.xpath('//body/div/div/div[1]/table/tr[11]/td[4]/text()').extract_first() or ''
            result.append(pinfo)
        return result
