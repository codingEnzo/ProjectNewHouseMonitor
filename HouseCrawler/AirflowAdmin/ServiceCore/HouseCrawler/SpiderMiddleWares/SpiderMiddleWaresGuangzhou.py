    ...
    def process_spider_output(self, response, result, spider):
        ...
        if response.meta.get('GetPage'):
            ...
            for i in range(total_page):
                url = 'http://www.gzcc.gov.cn/housing/fyxx/fdcxmxx/index_{curPage}.shtml'.format(
                    curPage=i)
                if i == 0:
...
class IframePageHandleMiddleware(object):
    ...
    def process_spider_output(self, response, result, spider):
        ...
        project_info_url = 'http://www.gzcc.gov.cn/housing/search/project/' + \
            url_list[0]
        ...
        ProjectName = response.xpath(
            '//input[@name="pjName"]/@value').extract_first()
        ...
        if 'country_name' in CertificateOfUseOfStateOwnedLand_dict:
            CertificateOfUseOfStateOwnedLand = CertificateOfUseOfStateOwnedLand_dict[
                'country_name'][:-1]
            if ',' in CertificateOfUseOfStateOwnedLand:
                ...
                countryId = CertificateOfUseOfStateOwnedLand_dict[
                    'country_id'][:-1]
        ...
        if 'agreeName' in ConstructionPermitNumber_dict:
            ConstructionPermitNumber = ConstructionPermitNumber_dict[
                'agreeName'][:-1]
            ...
            if ',' in BuildingPermit:
                ...
                for index, layoutId in enumerate(layoutIds):
                    ...
                    body = urlparse.urlencode(
                        req_dict) + '&' + urlparse.urlencode(req_dict2)
    ...
    def process_spider_output(self, response, result, spider):
        ...
        if response.meta.get('PageType') == 'StreetInfo':
            ...
            presellArea_gif_list = response.xpath('//td[starts-with(text(),"批准预售面积")]/following-sibling::td[1]').re(
                '/images/(\w+).gif')
            projectInfoItem['ApprovalPresaleArea'] = imgToNumberText(
                NUMBER_IMG, presellArea_dot, presellArea_gif_list)
            ...
            soldCount_gif_list = response.xpath('//td[starts-with(text(),"已售总套数")]/following-sibling::td[1]').re(
                '/images/(\w+).gif')
            projectInfoItem['TotalSoldAmount'] = imgToNumberText(
                NUMBER_IMG, soldCount_dot, soldCount_gif_list)
            ...
            unsoldCount_gif_list = response.xpath('//td[starts-with(text(),"未售总套数")]/following-sibling::td[1]').re(
                '/images/(\w+).gif')
            projectInfoItem['TotalUnsoldAmount'] = imgToNumberText(
                NUMBER_IMG, unsoldCount_dot, unsoldCount_gif_list)
            ...
            soldArea_gif_list = response.xpath('//td[starts-with(text(),"已售总面积")]/following-sibling::td[1]').re(
                '/images/(\w+).gif')
            projectInfoItem['TotalSoldArea'] = imgToNumberText(
                NUMBER_IMG, soldArea_dot, soldArea_gif_list)
            ...
            unsoldArea_gif_list = response.xpath('//td[starts-with(text(),"未售总面积")]/following-sibling::td[1]').re(
                '/images/(\w+).gif')
            projectInfoItem['TotalUnsoldArea'] = imgToNumberText(
                NUMBER_IMG, unsoldArea_dot, unsoldArea_gif_list)
            house_sold_count_dot = response.xpath(
                '//td[text()="住宅"]/following-sibling::td[4]').re('(.*)>.<(img.*)')
            house_sold_count_gif_list = response.xpath('//td[text()="住宅"]/following-sibling::td[4]').re(
                '/images/(\w+).gif')
            house_sold_count = imgToNumberText(
                NUMBER_IMG, house_sold_count_dot, house_sold_count_gif_list)
            house_sold_area_dot = response.xpath(
                '//td[text()="住宅"]/following-sibling::td[5]').re('(.*)>.<(img.*)')
            house_sold_area_gif_list = response.xpath('//td[text()="住宅"]/following-sibling::td[5]').re(
                '/images/(\w+).gif')
            house_sold_area = imgToNumberText(
                NUMBER_IMG, house_sold_area_dot, house_sold_area_gif_list)
            house_sold_price_dot = response.xpath(
                '//td[text()="住宅"]/following-sibling::td[6]').re('(.*)>.<(img.*)')
            house_sold_price_gif_list = response.xpath('//td[text()="住宅"]/following-sibling::td[6]').re(
                '/images/(\w+).gif')
            house_sold_price = imgToNumberText(
                NUMBER_IMG, house_sold_price_dot, house_sold_price_gif_list)
            ...
            house_unsold_count_gif_list = response.xpath('//td[text()="住宅"]/following-sibling::td[7]').re(
                '/images/(\w+).gif')
            house_unsold_count = imgToNumberText(
                NUMBER_IMG, house_unsold_count_dot, house_unsold_count_gif_list)
            ...
            house_unsold_area_gif_list = response.xpath('//td[text()="住宅"]/following-sibling::td[8]').re(
                '/images/(\w+).gif')
            house_unsold_area = imgToNumberText(
                NUMBER_IMG, house_unsold_area_dot, house_unsold_area_gif_list)
            ...
            business_sold_count_gif_list = response.xpath('//td[text()="商业"]/following-sibling::td[4]').re(
                '/images/(\w+).gif')
            business_sold_count = imgToNumberText(
                NUMBER_IMG, business_sold_count_dot, business_sold_count_gif_list)
            ...
            business_sold_area_gif_list = response.xpath('//td[text()="商业"]/following-sibling::td[5]').re(
                '/images/(\w+).gif')
            business_sold_area = imgToNumberText(
                NUMBER_IMG, business_sold_area_dot, business_sold_area_gif_list)
            ...
            business_sold_price_gif_list = response.xpath('//td[text()="商业"]/following-sibling::td[6]').re(
                '/images/(\w+).gif')
            business_sold_price = imgToNumberText(
                NUMBER_IMG, business_sold_price_dot, business_sold_price_gif_list)
            ...
            business_unsold_area_gif_list = response.xpath('//td[text()="商业"]/following-sibling::td[8]').re(
                '/images/(\w+).gif')
            business_unsold_area = imgToNumberText(
                NUMBER_IMG, business_unsold_area_dot, business_unsold_area_gif_list)
            ...
            office_sold_count_gif_list = response.xpath('//td[text()="办公"]/following-sibling::td[4]').re(
                '/images/(\w+).gif')
            office_sold_count = imgToNumberText(
                NUMBER_IMG, office_sold_count_dot, office_sold_count_gif_list)
            office_sold_area_dot = response.xpath(
                '//td[text()="办公"]/following-sibling::td[5]').re('(.*)>.<(img.*)')
            office_sold_area_gif_list = response.xpath('//td[text()="办公"]/following-sibling::td[5]').re(
                '/images/(\w+).gif')
            office_sold_area = imgToNumberText(
                NUMBER_IMG, office_sold_area_dot, office_sold_area_gif_list)
            ...
            office_sold_price_gif_list = response.xpath('//td[text()="办公"]/following-sibling::td[6]').re(
                '/images/(\w+).gif')
            office_sold_price = imgToNumberText(
                NUMBER_IMG, office_sold_price_dot, office_sold_price_gif_list)
            ...
            office_unsold_count_gif_list = response.xpath('//td[text()="办公"]/following-sibling::td[7]').re(
                '/images/(\w+).gif')
            office_unsold_count = imgToNumberText(
                NUMBER_IMG, office_unsold_count_dot, office_unsold_count_gif_list)
            ...
            office_unsold_area_gif_list = response.xpath('//td[text()="办公"]/following-sibling::td[8]').re(
                '/images/(\w+).gif')
            office_unsold_area = imgToNumberText(
                NUMBER_IMG, office_unsold_area_dot, office_unsold_area_gif_list)
            ...
            parking_sold_count_gif_list = response.xpath('//td[text()="车位"]/following-sibling::td[4]').re(
                '/images/(\w+).gif')
            parking_sold_count = imgToNumberText(
                NUMBER_IMG, parking_sold_count_dot, parking_sold_count_gif_list)
            ...
            parking_sold_area_gif_list = response.xpath('//td[text()="车位"]/following-sibling::td[5]').re(
                '/images/(\w+).gif')
            parking_sold_area = imgToNumberText(
                NUMBER_IMG, parking_sold_area_dot, parking_sold_area_gif_list)
            ...
            parking_sold_price_gif_list = response.xpath('//td[text()="车位"]/following-sibling::td[6]').re(
                '/images/(\w+).gif')
            parking_sold_price = imgToNumberText(
                NUMBER_IMG, parking_sold_price_dot, parking_sold_price_gif_list)
            ...
            parking_unsold_count_gif_list = response.xpath('//td[text()="车位"]/following-sibling::td[7]').re(
                '/images/(\w+).gif')
            parking_unsold_count = imgToNumberText(
                NUMBER_IMG, parking_unsold_count_dot, parking_unsold_count_gif_list)
            ...
            parking_unsold_area_gif_list = response.xpath('//td[text()="车位"]/following-sibling::td[8]').re(
                '/images/(\w+).gif')
            parking_unsold_area = imgToNumberText(
                NUMBER_IMG, parking_unsold_area_dot, parking_unsold_area_gif_list)

            other_sold_count_dot = response.xpath(
                '//td[text()="其他"]/following-sibling::td[4]').re('(.*)>.<(img.*)')
            other_sold_count_gif_list = response.xpath('//td[text()="其他"]/following-sibling::td[4]').re(
                '/images/(\w+).gif')
            other_sold_count = imgToNumberText(
                NUMBER_IMG, other_sold_count_dot, other_sold_count_gif_list)
            other_sold_area_dot = response.xpath(
                '//td[text()="其他"]/following-sibling::td[5]').re('(.*)>.<(img.*)')
            other_sold_area_gif_list = response.xpath('//td[text()="其他"]/following-sibling::td[5]').re(
                '/images/(\w+).gif')
            other_sold_area = imgToNumberText(
                NUMBER_IMG, other_sold_area_dot, other_sold_area_gif_list)
            other_sold_price_dot = response.xpath(
                '//td[text()="其他"]/following-sibling::td[6]').re('(.*)>.<(img.*)')
            other_sold_price_gif_list = response.xpath('//td[text()="其他"]/following-sibling::td[6]').re(
                '/images/(\w+).gif')
            other_sold_price = imgToNumberText(
                NUMBER_IMG, other_sold_price_dot, other_sold_price_gif_list)
            ...
            other_unsold_count_gif_list = response.xpath('//td[text()="其他"]/following-sibling::td[7]').re(
                '/images/(\w+).gif')
            other_unsold_count = imgToNumberText(
                NUMBER_IMG, other_unsold_count_dot, other_unsold_count_gif_list)
            ...
            other_unsold_area_gif_list = response.xpath('//td[text()="其他"]/following-sibling::td[8]').re(
                '/images/(\w+).gif')
            other_unsold_area = imgToNumberText(
                NUMBER_IMG, other_unsold_area_dot, other_unsold_area_gif_list)
            projectInfoItem[
            ...
            house_sold_count_dot = response.xpath(
                '//td[text()="住宅"]/following-sibling::td[1]').re('(.*)>.<(img.*)')
            house_sold_count_gif_list = response.xpath('//td[text()="住宅"]/following-sibling::td[1]').re(
                '/images/(\w+).gif')
            house_sold_count = imgToNumberText(
                NUMBER_IMG, house_sold_count_dot, house_sold_count_gif_list)
            house_sold_area_dot = response.xpath(
                '//td[text()="住宅"]/following-sibling::td[2]').re('(.*)>.<(img.*)')
            ...
            business_sold_count_dot = response.xpath(
                '//td[text()="商业"]/following-sibling::td[1]').re('(.*)>.<(img.*)')
            business_sold_count_gif_list = response.xpath('//td[text()="商业"]/following-sibling::td[1]').re(
                '/images/(\w+).gif')
            business_sold_count = imgToNumberText(
                NUMBER_IMG, business_sold_count_dot, business_sold_count_gif_list)
            business_sold_area_dot = response.xpath(
                '//td[text()="商业"]/following-sibling::td[2]').re('(.*)>.<(img.*)')
            ...
            office_sold_count_dot = response.xpath(
                '//td[text()="办公"]/following-sibling::td[1]').re('(.*)>.<(img.*)')
            office_sold_count_gif_list = response.xpath('//td[text()="办公"]/following-sibling::td[1]').re(
                '/images/(\w+).gif')
            office_sold_count = imgToNumberText(
                NUMBER_IMG, office_sold_count_dot, office_sold_count_gif_list)
            office_sold_area_dot = response.xpath(
                '//td[text()="办公"]/following-sibling::td[2]').re('(.*)>.<(img.*)')
            ...
            parking_sold_count_dot = response.xpath(
                '//td[text()="车位"]/following-sibling::td[1]').re('(.*)>.<(img.*)')
            parking_sold_count_gif_list = response.xpath('//td[text()="车位"]/following-sibling::td[1]').re(
                '/images/(\w+).gif')
            parking_sold_count = imgToNumberText(
                NUMBER_IMG, parking_sold_count_dot, parking_sold_count_gif_list)
            parking_sold_area_dot = response.xpath(
                '//td[text()="车位"]/following-sibling::td[2]').re('(.*)>.<(img.*)')
            ...
            other_sold_count_dot = response.xpath(
                '//td[text()="其他"]/following-sibling::td[1]').re('(.*)>.<(img.*)')
            ...
            other_sold_area_dot = response.xpath(
                '//td[text()="其他"]/following-sibling::td[2]').re('(.*)>.<(img.*)')
...
class PresellInfoHandleMiddleware(object):
    ...
    def process_spider_output(self, response, result, spider):
        ...
        business_count = response.xpath(
            '//table[2]/tr[3]/td[4]/text()').extract_first()
        business_area = response.xpath(
            '//table[2]/tr[4]/td[4]/text()').extract_first()
        office_count = response.xpath(
            '//table[2]/tr[3]/td[4]/text()').extract_first()
        office_area = response.xpath(
            '//table[2]/tr[4]/td[4]/text()').extract_first()
        parking_count = response.xpath(
            '//table[2]/tr[3]/td[5]/text()').extract_first()
        parking_area = response.xpath(
            '//table[2]/tr[4]/td[5]/text()').extract_first()
        other_count = response.xpath(
            '//table[2]/tr[3]/td[6]/text()').extract_first()
        other_area = response.xpath(
            '//table[2]/tr[4]/td[6]/text()').extract_first()
        ...
        def getHouseLabel(response, font_list):
            if font_list:
                ...
                for font in font_list:
                    try:
                        text = response.xpath(
                            '//td[contains(text(),"' + font + '")]/text()').extract_first()
