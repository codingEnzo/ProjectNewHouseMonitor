        ...
        if isinstance(item, ProjectBaseItem):
            ...
            if diff_flag:
                ...
                if item.get('SourceUrl') is None and getattr(res_object, 'SourceUrl'):
                    item['FloorName'] = getattr(res_object, 'FloorName')
                    item['HouseUseType'] = getattr(res_object, 'HouseUseType')
                    item['HouseSalePrice'] = getattr(res_object, 'HouseSalePrice')
                    item['HouseSalePriceUpdateTime'] = getattr(res_object, 'HouseSalePriceUpdateTime')
                    item['SourceUrl'] = getattr(res_object, 'SourceUrl')
