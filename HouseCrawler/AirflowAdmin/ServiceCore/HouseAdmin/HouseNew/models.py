...
class House_DetailHuizhou(Document):
    ...
    PresalePermitNumberUUID = fields.UUIDField(default=uuid.uuid3(uuid.NAMESPACE_DNS, ''), binary=False, null=False,
                                               primary_key=False, choices=False)  # 预售证uuid
    BuildingUUID = fields.UUIDField(default=uuid.uuid3(uuid.NAMESPACE_DNS, ''), binary=False, null=False,
    ...
    ForecastBuildingArea = fields.StringField(default='', null=False, primary_key=False, choices=False)  # 预测建筑面积
    ...
    MeasuredBuildingArea = fields.StringField(default='', null=False, primary_key=False, choices=False)  # 实测建筑面积
    MeasuredInsideOfBuildingArea = fields.StringField(default='', null=False, primary_key=False,
                                                      choices=False)  # 实测套内面积
    MeasuredSharedPublicArea = fields.StringField(default='', null=False, primary_key=False, choices=False)  # 实测公摊面积
    SalePriceByBuildingArea = fields.StringField(default='', null=False, primary_key=False, choices=False)  # 按建筑面积拟售单价
    ...
    HouseSaleStateLatest = fields.StringField(default='', null=False, primary_key=False, choices=False)  # 上一次销售状态
